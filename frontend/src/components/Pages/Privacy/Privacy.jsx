      ...
      <div class="row mb-4">
        <div class="col">
          ...
          <div class="descr">
            ...
            >
              Воропаевым Иваном Алексеевичем
            </span>
      ...
      <div class="row mb-4">
        <div class="col">
          ...
          <div class="ol">
            ...
            <div class="li">
              5.6. Хранение персональных данных осуществляется в&nbsp;форме,
              ...
              <table class="purpose-table">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="data-field">
                      <p class="mark link">фамилия и имя</p>

                      <p class="mark link">
                        данные об аккаунтах социальных сетей Вконтакте и
                        Telegram
                      </p>
                    </td>
                  </tr>
